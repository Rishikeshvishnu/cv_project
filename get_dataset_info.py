...
def get_dataset_info(dataset):
    (img_names, im_width, im_height, focal_length_35mm, init_pair, pixel_threshold) = (0,0,0,0,0,0)
    ...
    if dataset == 1:
        ...
        # Suzanne 3D render
        img_names = ["data/10/suzanne1.jpg", "data/10/suzanne2.jpg", "data/10/suzanne3.jpg", "data/10/suzanne4.jpg", "data/10/suzanne5.jpg", "data/10/suzanne6.jpg", "data/10/suzanne7.jpg", "data/10/suzanne8.jpg"]
        (im_width, im_height) = (1920, 1080)
        # focal_length_35mm = 50.0 * (35.0 / 36.0)
        focal_length_35mm = 50.0
        init_pair = [1, 2]
        pixel_threshold = 10.0
    elif dataset == 11:
        # Piano render
        img_names = ["data/11/1.jpg", "data/11/2.jpg", "data/11/3.jpg", "data/11/4.jpg", "data/11/5.jpg"]
        (im_width, im_height) = (4000, 2250)
        focal_length_35mm = ((36**2.0 + 24**2.0)**0.5 / 8.0) * 4.7
        init_pair = [1, 2]
        pixel_threshold = 10.0
    ...
    return (
        K, img_names, init_pair, pixel_threshold
    )
